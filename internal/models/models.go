...
type ClientObject struct {
	...
	GeoLat    *float64   `json:"geoLat,omitempty" db:"geo_lat"`
	GeoLng    *float64   `json:"geoLng,omitempty" db:"geo_lng"`
	Notes     *string    `json:"notes,omitempty" db:"notes"`
	CreatedAt time.Time  `json:"createdAt" db:"created_at"`
	UpdatedAt time.Time  `json:"updatedAt" db:"updated_at"`
	DeletedAt *time.Time `json:"deletedAt,omitempty" db:"deleted_at"`
...
type Equipment struct {
	...
	VolumeL        int        `json:"volumeL" db:"volume_l"`
...
type Transport struct {
	ID                 uuid.UUID  `json:"id" db:"id"`
	PlateNo            string     `json:"plateNo" db:"plate_no"`
	Brand              string     `json:"brand" db:"brand"`
	Model              string     `json:"model" db:"model"`
	CapacityL          int        `json:"capacityL" db:"capacity_l"`
	CurrentDriverID    *uuid.UUID `json:"currentDriverId" db:"current_driver_id"`
	CurrentEquipmentID *uuid.UUID `json:"currentEquipmentId" db:"current_equipment_id"`
